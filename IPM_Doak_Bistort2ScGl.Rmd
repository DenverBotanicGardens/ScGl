...
size_scgl <- sg_ipm[,c("Site","Transect","szs0","szs1","minis0","survival","Fl.x", "Year.x", "Year.y")]
...
colnames(size_scgl) <- c("Site", "Transect", "t0","t1","minis0","survival","reproyesno","year0","year1")
...
size_scgl <- merge(size_scgl, sizeforrepro_scgl, 
                   by = c("Site","Transect","t0","t1","minis0","survival","reproyesno","year0","year1"))
#################### #################### 
...
### Keep only data that follows the whole way through <-- do this for sie_scgl
...
```{r}
table(size_scgl$Site)
table(size_scgl$Site, size_scgl$year0)

size_scgl$Site <- as.character(size_scgl$Site)
size_scgl$Site[grep("Atwell", size_scgl$Site)] <- "Atwell Gulch"
