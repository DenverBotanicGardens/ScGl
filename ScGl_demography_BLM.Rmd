...
#Figure 4a
```{r}
jpeg(paste("Q:/Research/All_Projects_by_Species/Sclerocactus SPECIES/Sclerocactus_glaucus/Word/ScGl ",currentYr,"/Fig4a.jpg", sep=""), width=175, height=125, units="mm", res=300)
