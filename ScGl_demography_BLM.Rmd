...
# "C:\Users\deprengm\Denver Botanic Gardens\Conservation - General\AllProjectsBySpecies\Sclerocactus-glaucus\Sclerocactus-glaucus_AnnualReports\2008-currentyr_Sclerocactus_glaucus_R_tables\RawData_scgl_2021.csv"
...
sg[sg$Height.cm. > 7.5 & sg$Site == "Pond" & !is.na(sg$Height.cm.),]
```
...
# write.table(poststand, file=paste("Q:/Research/All_Projects_by_Species/Sclerocactus SPECIES/Sclerocactus_glaucus/Word/ScGl ",currentYr,"/Table2_poststand.csv", 
write.table(poststand, file = paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/Table2_poststand.csv", sep=""), sep=",", row.names=FALSE, col.names = TRUE)
...
write.table(prestand, file = paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/Table2_prestand.csv", sep=""),
...
save(scgl.climate, file=paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"climate.Rdata", sep=""))

```

```{r}
load(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"climate.Rdata", sep=""))
...
write.table(Table3a[!duplicated(Table3a$Freq),], file=paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Table3a.csv", sep=""), 
            sep=",", row.names=FALSE, col.names = TRUE)
...
#Figure 4b  
```{r}
sg.pc86current$Site <- as.factor(sg.pc86current$Site)

jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig4b.jpg", sep=""), width=175, height=125, units="mm", res=300)
...
#Figure 4a
```{r}
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig4a.jpg", sep=""), width=125, height=125, units="mm", res=300)
...
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig4c.jpg", sep=""), width=275, height=125, units="mm", res=300)
...
write.table(Table3b[!duplicated(Table3b$Freq),], file = paste(userpath,"Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports",currentYr,"Table3b.csv", sep=""), 
            sep=",", row.names=FALSE, col.names = TRUE)
...
```{r}
jpeg( paste(userpath,"Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports",currentYr,"Fig4e.jpg", sep=""), width=175, height=125, units="mm", res=300)
...
jpeg(paste(userpath,"Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports",currentYr,"Fig4d.jpg", sep=""), width=175, height=125, units="mm", res=300)
...
```{r}
#doesn't like "-" in the name
sg.pc.r$Site <- as.character(sg.pc.r$Site)
sg.pc.r$Site[sg.pc.r$Site == "T-Junciton"] <- "TJunction"
sg.pc.r$Site <- as.factor(sg.pc.r$Site)
...
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig4f.jpg", sep=""), width=275, height=125, units="mm", res=300)
...
## Should be binomial
lm1 <- glm(Prepro~avgVol,family = "binomial", sg_sum)
lm2 <- glm(Prepro~avgW, family = "binomial",sg_sum)
lm3 <- glm(Prepro~avgH, family = "binomial",sg_sum) 
lm4 <- glm(Prepro~avgVol*Site,family = "binomial", sg_sum)
lm5 <- glm(Prepro~avgW*Site, family = "binomial",sg_sum)
lm6 <- glm(Prepro~avgH*Site, family = "binomial",sg_sum) 
lm7 <- glm(Prepro~avgVol*NS,family = "binomial", sg_sum)
lm8 <- glm(Prepro~avgW*NS, family = "binomial",sg_sum)
lm9 <- glm(Prepro~avgH*NS, family = "binomial",sg_sum) 
...
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig3a.jpg", sep=""), width=250, height=125, units="mm", res=300)
...
### Figure 3b
```{r}
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig3b.jpg", sep=""), width=250, height=125, units="mm", res=300)
...
##FIGURE 3c
```{r}
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig3c.jpg", sep=""), width=250, height=125, units="mm", res=300)
...
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig6.jpg", sep=""), width=250, height=125, units="mm", res=300)
...
## Yarg, should find best fit model for each part - reproduction, survival of juveniles, survival of adults
```{r}
...
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig2.jpg", sep=""), width=250, height=200, units="mm", res=300)
...
```{r}
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig5a.jpg", sep=""), width=200, height=125, units="mm", res=300)
...
```{r}
jpeg(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig5b.jpg", sep=""), width=200, height=125, units="mm", res=300)
...
ggsave(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/ScGl_yr.jpg", sep=""),device="jpeg",
       ggplot(plotout1, aes(Year,X))+
...
write.csv(plotout1, paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/2021_Sclerocactus-glaucus_AnnualReport/ScGl_data.csv", sep=""))
```
