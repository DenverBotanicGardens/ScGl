...
get_prism_monthlys(type="ppt", mon = 1:12, keepZip = FALSE, years = 1986:2016)
...
get_prism_monthlys(type="tmax", mon = 1:12, keepZip = FALSE, years = 1986:2016)

# Minimum temperature (average)
get_prism_monthlys(type="tmin", mon = 1:12, keepZip = FALSE, years = 1986:2016)
```
...
### START HERE
### Issues with 2016 being provisional so pulling year and month from number is funny, should pull from last two and first four after split by underscore.... remove "provisional_" first and then it'll work?
...
season <- reshape(scgl.c.summary[scgl.c.summary$Prev12<2017,],
                  idvar = c("Site","Prev12"),
                  timevar = "season",
                  direction = "wide")
