...
scgl.climate <- rbind(at.cli,br.cli,es.cli,fr.cli,op.cli,pic.cli,power.cli,pr.cli,tj.cli)
...
#### 2008-2015
Ditch anything 50% or more correlated 
Keep Precip.fall and  Remove: tmax.fall(-0.60) 
                              Precip.summer(0.51)
     tmin.fall
     Precip.spring            tmax.spring(-0.56)
...
tomatch <- c("tmax.fall","Year","Month","Site","Prev12",
             "Precip.summer","tmax.spring","Precip.winter")
...
sg_sum$SiteSame[sg_sum$Site%in%unique ]
require(scales)
