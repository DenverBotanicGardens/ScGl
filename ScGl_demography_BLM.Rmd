...
sg_sum$area[sg_sum$Site == "Atwell Gulch"] <- 390 # correct, 2012 and beyond is 390
sg_sum$area[sg_sum$Site == "Atwell Gulch (old)"] <- 300
sg_sum$area[sg_sum$Site == "Fram"] <- 2600 # 1300, not adjacent, treat them as if they're within 2600m2
