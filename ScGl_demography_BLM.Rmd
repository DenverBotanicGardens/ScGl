...
```{r}
tomatch <- c("tmax","Year","Month","Site","Prev12",
             "tmin.summer","tmin.spring")
...
Figure 3 c) Site distribution along PC1 is shown with Tukey Honest Significant Differences. 
