...
flpl1 <- sg_annual_scaled %>%
  ...
  ggplot(  aes(Width.cm.,Fl, color = as.factor(Br)))+
    ...
    ylab("Probability of Reproduction")+
    xlab("Size (width cm)")
ggsave(paste(userpath, "Denver Botanic Gardens/Conservation - General/AllProjectsBySpecies/Sclerocactus-glaucus/Sclerocactus-glaucus_AnnualReports/",currentYr,"_Sclerocactus-glaucus_AnnualReport/",currentYr,"Fig_ProbofReproductive.jpg", sep=""),flpl1, width = 200, height = 110, units = 'mm', dpi=300)
