...
scgl.climate <- rbind(at.cli,br.cli,es.cli,op.cli,pic.cli,power.cli,pr.cli,tj.cli)
...
Ditch anything 50% or more correlated 
  keep  Precip.fall   Remove: tmax.fall(-0.65)
        tmax.fall             tmin.summer(0.56)
        Precip.spring         tmax.spring(-0.53)
        tmin.spring
        Precip.summer         tmax.summer(-0.56)
        Precip.winter         
        tmin.winter
        tmax.winter
...
tomatch <- c("tmax.fall","Year","Month","Site","Prev12",
             "tmin.summer","tmax.spring","tmax.summer")
