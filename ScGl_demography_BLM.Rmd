...
summarySE(rep.per, measurevar="PRep")
...
Table3a[with(Table3a, order(Table3a$Freq)),]
...
sg.pc.lambda <- merge(sg.pc, lambdas, by.x = c("Site","Prev12"), by.y = c("Site","Year2"))
